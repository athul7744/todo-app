...
function DialogContent({
  ...
  const defaultInitialFocus = React.useCallback((openType: string) => {
    if (openType === "touch") {
      return false
    }
  ...
  const resolvedInitialFocus = initialFocus ?? defaultInitialFocus
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          ...
          disableDefaultAnimation ? null : "data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95",
          className
        )}
        {...props}
      >
