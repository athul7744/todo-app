...
An offline-first productivity dashboard with **Task Management**, **Time Tracking**, and an in-progress **Notes** module. It works offline, applies optimistic UI locally, and syncs to the cloud in the background when connectivity returns.
...
**Notes** — Local-first PKM foundation with page, block, edge, and attachment tables wired into the shared app shell. Editor and graph UX are still in progress.
